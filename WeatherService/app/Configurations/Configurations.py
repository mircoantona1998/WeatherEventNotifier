...
class Configurations:
    ...
    def _load_configurations(self):
        ...
        # Usa le variabili d'ambiente, altrimenti carica default
            ...
            self.consumer_group_id = os.getenv("CONSUMER_GROUP_ID", "WeatherService")
            ...
            self.producer_client_id = os.getenv("PRODUCER_CLIENT_ID", "WeatherService")
            print(str(self.producer_client_id))
            self.group_id = os.getenv("GROUP_ID", "WeatherService")
