...
class Configurations:
    ...
    def _load_configurations(self):
        ...
        # Usa le variabili d'ambiente, altrimenti carica default
            ...
            self.consumer_group_id = os.getenv("CONSUMER_GROUP_ID", "ForecastService")
            ...
            self.producer_client_id = os.getenv("PRODUCER_CLIENT_ID", "ForecastService")
            print(str(self.producer_client_id))
            self.group_id = os.getenv("GROUP_ID", "ForecastService")
            print(str(self.group_id))
            self.topic_to_manager = os.getenv("TOPIC_TO_MANAGER", "topic_to_manager")
            print(str(self.topic_to_manager))
            self.topic_to_forecast = os.getenv("TOPIC_TO_FORECAST", "topic_to_forecast")
            print(str(self.topic_to_forecast))
