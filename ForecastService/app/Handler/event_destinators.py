...
class GestoreDestinatari:
    ...
    def determina_destinatario(self, header_creator):
        if header_creator == "SLAManager":
            return Configurations().topic_to_manager
        elif header_creator == "ExposeAPIService":
        ...
        elif header_creator == "ForecastService":
            return Configurations().topic_to_forecast
