...
class Configurations:
    ...
    def _load_configurations(self):
        ...
        # Usa le variabili d'ambiente, altrimenti carica default
            ...
            print(str(self.consumer_group_id))
            self.user_database_username = os.getenv("USER_DATABASE_USERNAME", "sa")
            print(str(self.database_username))
            self.user_database_password = os.getenv("USER_DATABASE_PASSWORD", "RootRoot.1")
            print(str(self.database_password))
            self.user_database_porta = os.getenv("USER_DATABASE_PORTA", "1433")
            print(str(self.database_porta))
            self.user_database_ip = os.getenv("USER_DATABASE_IP", "127.0.0.1")
            print(str(self.database_ip))
            self.user_database_name = os.getenv("USER_DATABASE_NAME", "Userdata")
