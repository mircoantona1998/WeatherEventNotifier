...
public partial class RegisterPage : ContentPage
{
    ...
    {
        if(entryName.Text.Length >0 && entrySurname.Text.Length > 0 && entryUsername.Text.Length > 0 && entryPassword.Text.Length> 0 && entryCAP.Text.Length > 0 && entryCity.Text.Length > 0 && entryAddress.Text.Length>0) { 
